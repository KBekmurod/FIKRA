...
const QUESTIONS = [
  ...
  // ═══════════════════════════════════════════════════════════════════
  { subject: 'majburiy_onatili', block: 'majburiy', question: '"Sayhonlik" so\'zining ma\'nosi nima?', options: ['Tekis maydon', 'Bog\'-rog\'', 'Daryo bo\'yi', 'Tog\' yonbag\'ri'], answer: 0, explanation: 'Sayhonlik — kichik tekislik, daladir.' },
  { subject: 'majburiy_onatili', block: 'majburiy', question: 'Quyidagi qaysi gapda ravish ishlatilgan?\n"O\'quvchilar ___ darsda qatnashdilar."', options: ['faol', 'yaxshi', 'tezda', 'aqlli'], answer: 2, explanation: '"Tezda" — ravish, harakatning belgisini bildiradi.' },
  { subject: 'majburiy_onatili', block: 'majburiy', question: '"Bilim olish — nur olish" — bu qanday gap?', options: ['Sodda gap', 'Murakkab gap', 'Ergash gapli qo\'shma gap', 'Bog\'lovchili qo\'shma gap'], answer: 0, explanation: 'Sodda gap, ot kesim ifodalangan.' },
  { subject: 'majburiy_onatili', block: 'majburiy', question: '"Otam ishlamoqda" gapidagi kesimning shakli qaysi?', options: ['Sodda', 'Tarkibli', 'Qo\'shma', 'Murakkab'], answer: 1, explanation: '"Ishlamoqda" — tarkibli kesim (yordamchi fe\'l + ravishdosh).' },
  { subject: 'majburiy_onatili', block: 'majburiy', question: 'Bog\'lovchining qaysi turi quyida berilgan: "ammo, lekin, biroq"?', options: ['Teng bog\'lovchi', 'Ergashtiruvchi bog\'lovchi', 'Zidlov bog\'lovchi', 'Sabab bog\'lovchi'], answer: 2, explanation: 'Bu zidlov bog\'lovchilar — ikki gapni qarshi qo\'yadi.' },
  { subject: 'majburiy_onatili', block: 'majburiy', question: 'Qaysi qatorda undov gap to\'g\'ri ko\'rsatilgan?', options: ['Bugun havo issiq.', 'Voy, qanday chiroyli!', 'Sen kelding-mi?', 'Kitob o\'qiyman.'], answer: 1, explanation: 'Undov gap his-tuyg\'uni ifodalaydi va undov belgisi bilan tugaydi.' },
  { subject: 'majburiy_onatili', block: 'majburiy', question: 'Quyidagi qaysi so\'z fe\'l yasovchi qo\'shimcha?', options: ['-chi', '-lash', '-li', '-siz'], answer: 1, explanation: '-lash qo\'shimchasi otdan fe\'l yasaydi: ish-lash, gap-lash.' },
  { subject: 'majburiy_onatili', block: 'majburiy', question: '"O\'tgan o\'tinga kuyilmas" maqolining ma\'nosi?', options: ['Eski narsa kerak emas', 'O\'tib ketgan ish uchun afsuslanmaslik kerak', 'O\'tin mahalliga sazovor', 'Yangi narsa qadrli'], answer: 1, explanation: 'Bu maqol — o\'tib ketgan voqeaga afsuslanmasdan kelajakka qarash kerakligini bildiradi.' },
  { subject: 'majburiy_onatili', block: 'majburiy', question: 'Alisher Navoiyning "Xamsa" asariga necha doston kiradi?', options: ['3', '4', '5', '6'], answer: 2, explanation: '"Xamsa" — beshlik degani, 5 ta dostondan iborat.' },
  { subject: 'majburiy_onatili', block: 'majburiy', question: '"Boburnoma" qaysi yillarda yozilgan?', options: ['1483-1530', '1494-1530', '1500-1545', '1525-1550'], answer: 1, explanation: 'Bobur 1494 yildan boshlab voqealarni yozib bordi va u 1530 yilda vafot etdi.' },
  { subject: 'majburiy_onatili', block: 'majburiy', question: 'Cho\'lpon qaysi yillarda yashagan?', options: ['1893-1938', '1897-1938', '1900-1937', '1885-1940'], answer: 1, explanation: 'Abdulhamid Cho\'lpon 1897-1938 yillarda yashagan, 1938 yil qatag\'on qurboni bo\'lgan.' },
  { subject: 'majburiy_onatili', block: 'majburiy', question: '"Mehrobdan chayon" romani muallifi kim?', options: ['Abdulla Qodiriy', 'Abdulla Qahhor', 'Cho\'lpon', 'Hamid Olimjon'], answer: 0, explanation: 'Abdulla Qodiriy 1928 yilda bu romanni yozgan.' },
  { subject: 'majburiy_onatili', block: 'majburiy', question: 'Alisher Navoiy qancha yil yashagan?', options: ['58 yil', '60 yil', '64 yil', '69 yil'], answer: 0, explanation: 'Navoiy 1441-1501 (60 yil), aniq hisobda 60 yil yashagan, lekin yoshi 58 ham deyiladi (yangi oy hisobida).' },
  { subject: 'majburiy_onatili', block: 'majburiy', question: 'Quyidagi so\'zlardan qaysi biri o\'zlashgan emas?', options: ['Direktor', 'Daftar', 'Maktab', 'Kitob'], answer: 1, explanation: 'Daftar fors-tojikdan kelgan, lekin uzoq tarixga ega va o\'zbekcha kabi keng tarqalgan. Boshqalar arabchadan.' },
  { subject: 'majburiy_onatili', block: 'majburiy', question: '"Iztirob" so\'zining sinonimi qaysi?', options: ['Quvonch', 'Kayfiyat', 'Azob', 'Tinchlik'], answer: 2, explanation: 'Iztirob — qattiq qiynalish, azoblanish.' },

  // ═══════════════════════════════════════════════════════════════════
  // MATEMATIKA
  // ═══════════════════════════════════════════════════════════════════
  { subject: 'majburiy_math', block: 'majburiy', question: '2x + 5 = 15 tenglamadagi x ning qiymati?', options: ['3', '5', '7', '10'], answer: 1, explanation: '2x = 10 → x = 5' },
  { subject: 'majburiy_math', block: 'majburiy', question: 'log₂(8) ning qiymati nimaga teng?', options: ['2', '3', '4', '8'], answer: 1, explanation: '2³ = 8 bo\'lgani uchun log₂(8) = 3' },
  { subject: 'majburiy_math', block: 'majburiy', question: '√144 + √81 = ?', options: ['19', '20', '21', '23'], answer: 2, explanation: '12 + 9 = 21' },
  { subject: 'majburiy_math', block: 'majburiy', question: 'sin(30°) qiymati?', options: ['1/2', '√2/2', '√3/2', '1'], answer: 0, explanation: 'sin(30°) = 1/2' },
  { subject: 'majburiy_math', block: 'majburiy', question: '5! (5 faktorial) ning qiymati?', options: ['25', '60', '120', '720'], answer: 2, explanation: '5! = 5×4×3×2×1 = 120' },
  { subject: 'majburiy_math', block: 'majburiy', question: '(x+3)² formulasi qanday yoyiladi?', options: ['x² + 9', 'x² + 6x + 9', 'x² + 3x + 9', 'x² + 6'], answer: 1, explanation: '(a+b)² = a² + 2ab + b² → x² + 6x + 9' },
  { subject: 'majburiy_math', block: 'majburiy', question: 'Doiraning yuzasi formulasi qaysi? (r — radius)', options: ['πr', '2πr', 'πr²', 'πd'], answer: 2, explanation: 'Doira yuzi = πr²' },
  { subject: 'majburiy_math', block: 'majburiy', question: '|−7| + |3| = ?', options: ['−10', '−4', '4', '10'], answer: 3, explanation: '|−7| = 7, |3| = 3, 7+3 = 10' },
  { subject: 'majburiy_math', block: 'majburiy', question: '3x − 2 < 7 tengsizlikning yechimi qaysi?', options: ['x < 3', 'x > 3', 'x < 5', 'x > 5'], answer: 0, explanation: '3x < 9 → x < 3' },
  { subject: 'majburiy_math', block: 'majburiy', question: 'Arifmetik progressiyaning 1-hadi 3, ayirmasi 4. 5-hadi nimaga teng?', options: ['15', '17', '19', '23'], answer: 2, explanation: 'aₙ = a₁ + (n-1)d → a₅ = 3 + 4·4 = 19' },
  { subject: 'majburiy_math', block: 'majburiy', question: 'Geometrik progressiya: 2, 6, 18, ... 5-hadi qancha?', options: ['54', '108', '162', '216'], answer: 2, explanation: 'b₅ = 2·3⁴ = 2·81 = 162' },
  { subject: 'majburiy_math', block: 'majburiy', question: 'cos²(x) + sin²(x) = ?', options: ['0', '1', 'x', '2'], answer: 1, explanation: 'Bu trigonometriyaning asosiy ayniyati: har doim 1 ga teng.' },
  { subject: 'majburiy_math', block: 'majburiy', question: 'lim(x→0) sin(x)/x = ?', options: ['0', '1', '∞', 'aniqlanmagan'], answer: 1, explanation: 'Bu birinchi ajoyib limit, qiymati 1.' },
  { subject: 'majburiy_math', block: 'majburiy', question: 'f(x) = x² ning hosilasi?', options: ['x', '2x', 'x³/3', '2x²'], answer: 1, explanation: '(xⁿ)\' = n·xⁿ⁻¹ → 2x' },
  { subject: 'majburiy_math', block: 'majburiy', question: '(2x − 1)(x + 3) = 0 tenglamaning ildizlari?', options: ['x=1, x=3', 'x=1/2, x=-3', 'x=-1/2, x=3', 'x=2, x=3'], answer: 1, explanation: '2x-1=0 → x=1/2; x+3=0 → x=-3' },
  { subject: 'majburiy_math', block: 'majburiy', question: '2³ · 2⁴ = ?', options: ['2⁷', '2¹²', '4⁷', '2⁶'], answer: 0, explanation: 'Bir xil asosli darajalarni ko\'paytirganda darajalar qo\'shiladi: 2³⁺⁴ = 2⁷' },
  { subject: 'majburiy_math', block: 'majburiy', question: 'Uchburchakning ichki burchaklari yig\'indisi necha gradus?', options: ['90°', '180°', '270°', '360°'], answer: 1, explanation: 'Har qanday uchburchak burchaklari yig\'indisi 180°.' },
  { subject: 'majburiy_math', block: 'majburiy', question: 'O\'rtacha arifmetik: 4, 8, 12, 16, 20 = ?', options: ['10', '12', '14', '16'], answer: 1, explanation: '(4+8+12+16+20)/5 = 60/5 = 12' },

  // ═══════════════════════════════════════════════════════════════════
  // O'ZBEKISTON TARIXI
  // ═══════════════════════════════════════════════════════════════════
  { subject: 'majburiy_tarix', block: 'majburiy', question: 'O\'zbekiston Respublikasi qachon mustaqillikni e\'lon qildi?', options: ['1990-yil 20-iyun', '1991-yil 31-avgust', '1991-yil 1-sentabr', '1992-yil 8-dekabr'], answer: 1, explanation: '1991-yil 31-avgust kuni Oliy Kengash O\'zbekistonning mustaqilligini e\'lon qildi.' },
  { subject: 'majburiy_tarix', block: 'majburiy', question: 'Konstitutsiya qaysi yili qabul qilingan?', options: ['1991', '1992', '1993', '1995'], answer: 1, explanation: '1992-yil 8-dekabr kuni O\'zbekiston Konstitutsiyasi qabul qilindi.' },
  { subject: 'majburiy_tarix', block: 'majburiy', question: 'Amir Temurning poytaxti qaysi shahar edi?', options: ['Buxoro', 'Samarqand', 'Toshkent', 'Termiz'], answer: 1, explanation: 'Amir Temur Samarqandni o\'z saltanati poytaxtiga aylantirgan.' },
  { subject: 'majburiy_tarix', block: 'majburiy', question: 'Ulug\'bek qaysi yillarda hukmronlik qilgan?', options: ['1394-1449', '1409-1449', '1411-1449', '1420-1455'], answer: 1, explanation: 'Mirzo Ulug\'bek 1409-1449 yillarda hukmronlik qilgan.' },
  { subject: 'majburiy_tarix', block: 'majburiy', question: 'Buyuk ipak yo\'li qaysi davlatlarni bog\'lagan?', options: ['Hindiston-Yevropa', 'Xitoy-Yevropa', 'Eron-Arabiston', 'Misr-Hindiston'], answer: 1, explanation: 'Buyuk ipak yo\'li Xitoyni Yevropaga bog\'lagan asosiy savdo yo\'li edi.' },
  { subject: 'majburiy_tarix', block: 'majburiy', question: 'Beruniy qaysi shaharda tug\'ilgan?', options: ['Buxoro', 'Samarqand', 'Kat (Xorazm)', 'Termiz'], answer: 2, explanation: 'Abu Rayhon Beruniy 973-yilda Xorazmning Kat shahrida tug\'ilgan.' },
  { subject: 'majburiy_tarix', block: 'majburiy', question: 'Al-Xorazmiy qaysi fan asoschisi hisoblanadi?', options: ['Geografiya', 'Algebra', 'Tibbiyot', 'Falsafa'], answer: 1, explanation: 'Al-Xorazmiy "Algebra" fanining asoschisi, "algoritm" so\'zi ham uning nomidan kelib chiqqan.' },
  { subject: 'majburiy_tarix', block: 'majburiy', question: 'Buxoro xonligi qachon tashkil topgan?', options: ['1500', '1501', '1505', '1599'], answer: 1, explanation: 'Shayboniylar sulolasi 1501 yilda Buxoro xonligini tashkil etgan.' },
  { subject: 'majburiy_tarix', block: 'majburiy', question: 'Qaysi yili Toshkent Rossiya tomonidan bosib olingan?', options: ['1860', '1865', '1868', '1873'], answer: 1, explanation: '1865-yil 17-iyunda General Chernyaev Toshkentni bosib oldi.' },
  { subject: 'majburiy_tarix', block: 'majburiy', question: 'Jadidchilik harakati qachon boshlangan?', options: ['XVIII asr oxiri', 'XIX asr oxiri', 'XX asr boshi', 'XX asr o\'rtasi'], answer: 1, explanation: 'Jadidchilik XIX asr oxiri — XX asr boshlarida vujudga kelgan.' },
  { subject: 'majburiy_tarix', block: 'majburiy', question: 'Mahmudxo\'ja Behbudiy qaysi shaharda yashagan?', options: ['Toshkent', 'Buxoro', 'Samarqand', 'Qo\'qon'], answer: 2, explanation: 'Behbudiy Samarqandda yashab ijod qilgan, jadidchilik harakatining yetakchisi.' },
  { subject: 'majburiy_tarix', block: 'majburiy', question: 'O\'zbekiston SSR qachon tashkil topgan?', options: ['1922', '1924', '1925', '1929'], answer: 1, explanation: '1924-yil 27-oktabr kuni milliy chegaralanish natijasida tashkil topgan.' },
  { subject: 'majburiy_tarix', block: 'majburiy', question: 'Birinchi Prezident Islom Karimov qachon saylangan?', options: ['1990', '1991', '1992', '1995'], answer: 0, explanation: 'I.Karimov 1990-yil 24-mart kuni O\'zSSR Prezidenti etib saylangan.' },
  { subject: 'majburiy_tarix', block: 'majburiy', question: 'Mustaqillik shaharchasi qayerda joylashgan?', options: ['Toshkent', 'Samarqand', 'Buxoro', 'Andijon'], answer: 0, explanation: 'Toshkent shahrida joylashgan, mustaqillik ramzi.' },
  { subject: 'majburiy_tarix', block: 'majburiy', question: 'Ibn Sino qaysi shaharda tug\'ilgan?', options: ['Buxoro yaqinida (Afshana)', 'Samarqand', 'Termiz', 'Marv'], answer: 0, explanation: 'Abu Ali Ibn Sino 980-yilda Buxoro yaqinidagi Afshana qishlog\'ida tug\'ilgan.' },
