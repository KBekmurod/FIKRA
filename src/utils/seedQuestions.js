...
const QUESTIONS = [
  ...
  // ═══════════════════════════════════════════════════════════════════
  { subject: 'uztil', block: 'majburiy', question: "Qaysi so'z xato yozilgan?", options: ["Sanoat", "Manfaat", "Nihoyyat", "Tavallud"], answer: 2, explanation: "To'g'ri yozilishi — 'Nihoyat'." },
  { subject: 'uztil', block: 'majburiy', question: "Berilgan gapdagi nuqtalar o'rniga qaysi so'z mos keladi?\n'Kitob – aqlning ...'", options: ["boyligi", "chirog'i", "shifosi", "dushmani"], answer: 1, explanation: "Maqol: Kitob — aqlning chirog'i." },
  { subject: 'uztil', block: 'majburiy', question: "'Oqko'ngil' so'zining ma'nosi qaysi qatorda to'g'ri izohlangan?", options: ["Pudratni yaxshi ko'ruvchi", "Insonlarga doim yaxshilik tilovchi", "Qo'rqoq, yashirinib yuruvchi", "Mansa parast kishi"], answer: 1, explanation: "Oqko'ngil deb insonlarga beg'araz yaxshilik istovchi, g'arazi yo'q odamga aytiladi." },
  { subject: 'uztil', block: 'mutaxassislik', question: '"Sayhonlik" so\'zining ma\'nosi nima?', options: ['Tekis maydon', 'Bog\'-rog\'', 'Daryo bo\'yi', 'Tog\' yonbag\'ri'], answer: 0, explanation: 'Sayhonlik — kichik tekislik, daladir.' },
  { subject: 'uztil', block: 'mutaxassislik', question: 'Quyidagi qaysi gapda ravish ishlatilgan?\n"O\'quvchilar ___ darsda qatnashdilar."', options: ['faol', 'yaxshi', 'tezda', 'aqlli'], answer: 2, explanation: '"Tezda" — ravish, harakatning belgisini bildiradi.' },
  { subject: 'uztil', block: 'mutaxassislik', question: '"Bilim olish — nur olish" — bu qanday gap?', options: ['Sodda gap', 'Murakkab gap', 'Ergash gapli qo\'shma gap', 'Bog\'lovchili qo\'shma gap'], answer: 0, explanation: 'Sodda gap, ot kesim ifodalangan.' },
  { subject: 'uztil', block: 'mutaxassislik', question: '"Otam ishlamoqda" gapidagi kesimning shakli qaysi?', options: ['Sodda', 'Tarkibli', 'Qo\'shma', 'Murakkab'], answer: 1, explanation: '"Ishlamoqda" — tarkibli kesim (yordamchi fe\'l + ravishdosh).' },
  { subject: 'uztil', block: 'mutaxassislik', question: 'Bog\'lovchining qaysi turi quyida berilgan: "ammo, lekin, biroq"?', options: ['Teng bog\'lovchi', 'Ergashtiruvchi bog\'lovchi', 'Zidlov bog\'lovchi', 'Sabab bog\'lovchi'], answer: 2, explanation: 'Bu zidlov bog\'lovchilar — ikki gapni qarshi qo\'yadi.' },
  { subject: 'uztil', block: 'mutaxassislik', question: 'Qaysi qatorda undov gap to\'g\'ri ko\'rsatilgan?', options: ['Bugun havo issiq.', 'Voy, qanday chiroyli!', 'Sen kelding-mi?', 'Kitob o\'qiyman.'], answer: 1, explanation: 'Undov gap his-tuyg\'uni ifodalaydi va undov belgisi bilan tugaydi.' },
  { subject: 'uztil', block: 'mutaxassislik', question: 'Quyidagi qaysi so\'z fe\'l yasovchi qo\'shimcha?', options: ['-chi', '-lash', '-li', '-siz'], answer: 1, explanation: '-lash qo\'shimchasi otdan fe\'l yasaydi: ish-lash, gap-lash.' },
  { subject: 'uztil', block: 'mutaxassislik', question: '"O\'tgan o\'tinga kuyilmas" maqolining ma\'nosi?', options: ['Eski narsa kerak emas', 'O\'tib ketgan ish uchun afsuslanmaslik kerak', 'O\'tin mahalliga sazovor', 'Yangi narsa qadrli'], answer: 1, explanation: 'Bu maqol — o\'tib ketgan voqeaga afsuslanmasdan kelajakka qarash kerakligini bildiradi.' },
  { subject: 'uztil', block: 'mutaxassislik', question: 'Alisher Navoiyning "Xamsa" asariga necha doston kiradi?', options: ['3', '4', '5', '6'], answer: 2, explanation: '"Xamsa" — beshlik degani, 5 ta dostondan iborat.' },
  { subject: 'uztil', block: 'mutaxassislik', question: '"Boburnoma" qaysi yillarda yozilgan?', options: ['1483-1530', '1494-1530', '1500-1545', '1525-1550'], answer: 1, explanation: 'Bobur 1494 yildan boshlab voqealarni yozib bordi va u 1530 yilda vafot etdi.' },
  { subject: 'uztil', block: 'mutaxassislik', question: 'Cho\'lpon qaysi yillarda yashagan?', options: ['1893-1938', '1897-1938', '1900-1937', '1885-1940'], answer: 1, explanation: 'Abdulhamid Cho\'lpon 1897-1938 yillarda yashagan, 1938 yil qatag\'on qurboni bo\'lgan.' },
  { subject: 'uztil', block: 'mutaxassislik', question: '"Mehrobdan chayon" romani muallifi kim?', options: ['Abdulla Qodiriy', 'Abdulla Qahhor', 'Cho\'lpon', 'Hamid Olimjon'], answer: 0, explanation: 'Abdulla Qodiriy 1928 yilda bu romanni yozgan.' },
  { subject: 'uztil', block: 'mutaxassislik', question: 'Alisher Navoiy qancha yil yashagan?', options: ['58 yil', '60 yil', '64 yil', '69 yil'], answer: 0, explanation: 'Navoiy 1441-1501 (60 yil), aniq hisobda 60 yil yashagan, lekin yoshi 58 ham deyiladi (yangi oy hisobida).' },
  { subject: 'uztil', block: 'mutaxassislik', question: 'Quyidagi so\'zlardan qaysi biri o\'zlashgan emas?', options: ['Direktor', 'Daftar', 'Maktab', 'Kitob'], answer: 1, explanation: 'Daftar fors-tojikdan kelgan, lekin uzoq tarixga ega va o\'zbekcha kabi keng tarqalgan. Boshqalar arabchadan.' },
  { subject: 'uztil', block: 'mutaxassislik', question: '"Iztirob" so\'zining sinonimi qaysi?', options: ['Quvonch', 'Kayfiyat', 'Azob', 'Tinchlik'], answer: 2, explanation: 'Iztirob — qattiq qiynalish, azoblanish.' },

  // ═══════════════════════════════════════════════════════════════════
  // MATEMATIKA
  // ═══════════════════════════════════════════════════════════════════
  { subject: 'math', block: 'majburiy', question: "Noma'lum sonni toping: 35 + X = 82", options: ["47", "57", "117", "45"], answer: 0, explanation: "X = 82 - 35 = 47" },
  { subject: 'math', block: 'majburiy', question: "Hovuzning 25% qismi suv bilan to'lgan. Hovuzning qismi kasr ko'rinishida qanday ifodalanadi?", options: ["1/2", "1/4", "1/5", "3/4"], answer: 1, explanation: "25% = 25/100, bu qisqarganda 1/4 ga teng." },
  { subject: 'math', block: 'majburiy', question: "Do'konda 1 kg olma 12000 so'm turadi. 2.5 kg olma qancha bo'ladi?", options: ["30000 so'm", "24000 so'm", "28000 so'm", "32000 so'm"], answer: 0, explanation: "2.5 * 12000 = 30000 so'm." },
  { subject: 'math', block: 'mutaxassislik', question: '2x + 5 = 15 tenglamadagi x ning qiymati?', options: ['3', '5', '7', '10'], answer: 1, explanation: '2x = 10 → x = 5' },
  { subject: 'math', block: 'mutaxassislik', question: 'log₂(8) ning qiymati nimaga teng?', options: ['2', '3', '4', '8'], answer: 1, explanation: '2³ = 8 bo\'lgani uchun log₂(8) = 3' },
  { subject: 'math', block: 'mutaxassislik', question: '√144 + √81 = ?', options: ['19', '20', '21', '23'], answer: 2, explanation: '12 + 9 = 21' },
  { subject: 'math', block: 'mutaxassislik', question: 'sin(30°) qiymati?', options: ['1/2', '√2/2', '√3/2', '1'], answer: 0, explanation: 'sin(30°) = 1/2' },
  { subject: 'math', block: 'mutaxassislik', question: '5! (5 faktorial) ning qiymati?', options: ['25', '60', '120', '720'], answer: 2, explanation: '5! = 5×4×3×2×1 = 120' },
  { subject: 'math', block: 'mutaxassislik', question: '(x+3)² formulasi qanday yoyiladi?', options: ['x² + 9', 'x² + 6x + 9', 'x² + 3x + 9', 'x² + 6'], answer: 1, explanation: '(a+b)² = a² + 2ab + b² → x² + 6x + 9' },
  { subject: 'math', block: 'mutaxassislik', question: 'Doiraning yuzasi formulasi qaysi? (r — radius)', options: ['πr', '2πr', 'πr²', 'πd'], answer: 2, explanation: 'Doira yuzi = πr²' },
  { subject: 'math', block: 'mutaxassislik', question: '|−7| + |3| = ?', options: ['−10', '−4', '4', '10'], answer: 3, explanation: '|−7| = 7, |3| = 3, 7+3 = 10' },
  { subject: 'math', block: 'mutaxassislik', question: '3x − 2 < 7 tengsizlikning yechimi qaysi?', options: ['x < 3', 'x > 3', 'x < 5', 'x > 5'], answer: 0, explanation: '3x < 9 → x < 3' },
  { subject: 'math', block: 'mutaxassislik', question: 'Arifmetik progressiyaning 1-hadi 3, ayirmasi 4. 5-hadi nimaga teng?', options: ['15', '17', '19', '23'], answer: 2, explanation: 'aₙ = a₁ + (n-1)d → a₅ = 3 + 4·4 = 19' },
  { subject: 'math', block: 'mutaxassislik', question: 'Geometrik progressiya: 2, 6, 18, ... 5-hadi qancha?', options: ['54', '108', '162', '216'], answer: 2, explanation: 'b₅ = 2·3⁴ = 2·81 = 162' },
  { subject: 'math', block: 'mutaxassislik', question: 'cos²(x) + sin²(x) = ?', options: ['0', '1', 'x', '2'], answer: 1, explanation: 'Bu trigonometriyaning asosiy ayniyati: har doim 1 ga teng.' },
  { subject: 'math', block: 'mutaxassislik', question: 'lim(x→0) sin(x)/x = ?', options: ['0', '1', '∞', 'aniqlanmagan'], answer: 1, explanation: 'Bu birinchi ajoyib limit, qiymati 1.' },
  { subject: 'math', block: 'mutaxassislik', question: 'f(x) = x² ning hosilasi?', options: ['x', '2x', 'x³/3', '2x²'], answer: 1, explanation: '(xⁿ)\' = n·xⁿ⁻¹ → 2x' },
  { subject: 'math', block: 'mutaxassislik', question: '(2x − 1)(x + 3) = 0 tenglamaning ildizlari?', options: ['x=1, x=3', 'x=1/2, x=-3', 'x=-1/2, x=3', 'x=2, x=3'], answer: 1, explanation: '2x-1=0 → x=1/2; x+3=0 → x=-3' },
  { subject: 'math', block: 'mutaxassislik', question: '2³ · 2⁴ = ?', options: ['2⁷', '2¹²', '4⁷', '2⁶'], answer: 0, explanation: 'Bir xil asosli darajalarni ko\'paytirganda darajalar qo\'shiladi: 2³⁺⁴ = 2⁷' },
  { subject: 'math', block: 'mutaxassislik', question: 'Uchburchakning ichki burchaklari yig\'indisi necha gradus?', options: ['90°', '180°', '270°', '360°'], answer: 1, explanation: 'Har qanday uchburchak burchaklari yig\'indisi 180°.' },
  { subject: 'math', block: 'mutaxassislik', question: 'O\'rtacha arifmetik: 4, 8, 12, 16, 20 = ?', options: ['10', '12', '14', '16'], answer: 1, explanation: '(4+8+12+16+20)/5 = 60/5 = 12' },

  // ═══════════════════════════════════════════════════════════════════
  // O'ZBEKISTON TARIXI
  // ═══════════════════════════════════════════════════════════════════
  { subject: 'tarix', block: 'majburiy', question: "O'zbekiston Respublikasi Davlat bayrog'i qachon qabul qilingan?", options: ["1991-yil 18-noyabr", "1992-yil 2-iyul", "1991-yil 31-avgust", "1992-yil 8-dekabr"], answer: 0, explanation: "Davlat bayrog'i to'g'risidagi qonun 1991-yil 18-noyabrda tasdiqlangan." },
  { subject: 'tarix', block: 'majburiy', question: "Amir Temur davlatining poytaxti qaysi shahar bo'lgan?", options: ["Buxoro", "Xiva", "Samarqand", "Shahrisabz"], answer: 2, explanation: "Amir Temur saltanati markazini Samarqand qilib belgilagan." },
  { subject: 'tarix', block: 'majburiy', question: "Xorazm akademiyasi – “Ma'mun akademiyasi” qayerda faoliyat olib borgan?", options: ["G'azna", "Qo'qon", "Buxoro", "Gurganj"], answer: 3, explanation: "Xorazmshohlar poytaxti Gurganjda faoliyat yuritgan." },
  { subject: 'tarix', block: 'mutaxassislik', question: 'O\'zbekiston Respublikasi qachon mustaqillikni e\'lon qildi?', options: ['1990-yil 20-iyun', '1991-yil 31-avgust', '1991-yil 1-sentabr', '1992-yil 8-dekabr'], answer: 1, explanation: '1991-yil 31-avgust kuni Oliy Kengash O\'zbekistonning mustaqilligini e\'lon qildi.' },
  { subject: 'tarix', block: 'mutaxassislik', question: 'Konstitutsiya qaysi yili qabul qilingan?', options: ['1991', '1992', '1993', '1995'], answer: 1, explanation: '1992-yil 8-dekabr kuni O\'zbekiston Konstitutsiyasi qabul qilindi.' },
  { subject: 'tarix', block: 'mutaxassislik', question: 'Amir Temurning poytaxti qaysi shahar edi?', options: ['Buxoro', 'Samarqand', 'Toshkent', 'Termiz'], answer: 1, explanation: 'Amir Temur Samarqandni o\'z saltanati poytaxtiga aylantirgan.' },
  { subject: 'tarix', block: 'mutaxassislik', question: 'Ulug\'bek qaysi yillarda hukmronlik qilgan?', options: ['1394-1449', '1409-1449', '1411-1449', '1420-1455'], answer: 1, explanation: 'Mirzo Ulug\'bek 1409-1449 yillarda hukmronlik qilgan.' },
  { subject: 'tarix', block: 'mutaxassislik', question: 'Buyuk ipak yo\'li qaysi davlatlarni bog\'lagan?', options: ['Hindiston-Yevropa', 'Xitoy-Yevropa', 'Eron-Arabiston', 'Misr-Hindiston'], answer: 1, explanation: 'Buyuk ipak yo\'li Xitoyni Yevropaga bog\'lagan asosiy savdo yo\'li edi.' },
  { subject: 'tarix', block: 'mutaxassislik', question: 'Beruniy qaysi shaharda tug\'ilgan?', options: ['Buxoro', 'Samarqand', 'Kat (Xorazm)', 'Termiz'], answer: 2, explanation: 'Abu Rayhon Beruniy 973-yilda Xorazmning Kat shahrida tug\'ilgan.' },
  { subject: 'tarix', block: 'mutaxassislik', question: 'Al-Xorazmiy qaysi fan asoschisi hisoblanadi?', options: ['Geografiya', 'Algebra', 'Tibbiyot', 'Falsafa'], answer: 1, explanation: 'Al-Xorazmiy "Algebra" fanining asoschisi, "algoritm" so\'zi ham uning nomidan kelib chiqqan.' },
  { subject: 'tarix', block: 'mutaxassislik', question: 'Buxoro xonligi qachon tashkil topgan?', options: ['1500', '1501', '1505', '1599'], answer: 1, explanation: 'Shayboniylar sulolasi 1501 yilda Buxoro xonligini tashkil etgan.' },
  { subject: 'tarix', block: 'mutaxassislik', question: 'Qaysi yili Toshkent Rossiya tomonidan bosib olingan?', options: ['1860', '1865', '1868', '1873'], answer: 1, explanation: '1865-yil 17-iyunda General Chernyaev Toshkentni bosib oldi.' },
  { subject: 'tarix', block: 'mutaxassislik', question: 'Jadidchilik harakati qachon boshlangan?', options: ['XVIII asr oxiri', 'XIX asr oxiri', 'XX asr boshi', 'XX asr o\'rtasi'], answer: 1, explanation: 'Jadidchilik XIX asr oxiri — XX asr boshlarida vujudga kelgan.' },
  { subject: 'tarix', block: 'mutaxassislik', question: 'Mahmudxo\'ja Behbudiy qaysi shaharda yashagan?', options: ['Toshkent', 'Buxoro', 'Samarqand', 'Qo\'qon'], answer: 2, explanation: 'Behbudiy Samarqandda yashab ijod qilgan, jadidchilik harakatining yetakchisi.' },
  { subject: 'tarix', block: 'mutaxassislik', question: 'O\'zbekiston SSR qachon tashkil topgan?', options: ['1922', '1924', '1925', '1929'], answer: 1, explanation: '1924-yil 27-oktabr kuni milliy chegaralanish natijasida tashkil topgan.' },
  { subject: 'tarix', block: 'mutaxassislik', question: 'Birinchi Prezident Islom Karimov qachon saylangan?', options: ['1990', '1991', '1992', '1995'], answer: 0, explanation: 'I.Karimov 1990-yil 24-mart kuni O\'zSSR Prezidenti etib saylangan.' },
  { subject: 'tarix', block: 'mutaxassislik', question: 'Mustaqillik shaharchasi qayerda joylashgan?', options: ['Toshkent', 'Samarqand', 'Buxoro', 'Andijon'], answer: 0, explanation: 'Toshkent shahrida joylashgan, mustaqillik ramzi.' },
  { subject: 'tarix', block: 'mutaxassislik', question: 'Ibn Sino qaysi shaharda tug\'ilgan?', options: ['Buxoro yaqinida (Afshana)', 'Samarqand', 'Termiz', 'Marv'], answer: 0, explanation: 'Abu Ali Ibn Sino 980-yilda Buxoro yaqinidagi Afshana qishlog\'ida tug\'ilgan.' },
