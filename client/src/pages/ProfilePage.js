...
export default function ProfilePage() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "header", children: _jsxs("div", { className: "header-logo", children: ["FIKRA", _jsx("span", { children: "." })] }) }), _jsx("div", { style: { height: 6 } }), !user ? (_jsx("div", { style: { padding: '20px 20px', textAlign: 'center' }, children: _jsxs("div", { style: {
                        background: 'linear-gradient(135deg, rgba(123,104,238,0.1), rgba(0,212,170,0.05))',
                        border: '1px solid rgba(123,104,238,0.2)',
                        borderRadius: 24,
                        padding: '40px 20px',
                    }, children: [_jsx("div", { style: { fontSize: 50, marginBottom: 16 }, children: "\uD83D\uDC64" }), _jsx("h3", { style: { fontSize: 20, color: 'var(--txt)', marginBottom: 8, fontWeight: 800 }, children: "Siz mehmonsiz" }), _jsx("p", { style: { fontSize: 13, color: 'var(--txt-2)', marginBottom: 24, lineHeight: 1.5 }, children: "O'z darajangiz, statistikangiz va AI limitlaringizni ko'rish, shuningdek barcha qulayliklardan cheksiz foydalanish uchun profilingizga kiring." }), _jsxs("div", { style: { display: 'grid', gap: 12 }, children: [_jsx("button", { onClick: () => navigate('/auth/register'), style: {
                                        background: 'linear-gradient(135deg, var(--acc), var(--acc-l))',
                                        color: '#fff', border: 'none',
                                        padding: '14px', borderRadius: 14,
                                        fontSize: 14, fontWeight: 800, cursor: 'pointer'
                                    }, children: "Hisob yaratish" }), _jsx("button", { onClick: () => navigate('/auth/login'), style: {
                                        background: 'var(--s2)',
                                        color: 'var(--txt)', border: 'none',
                                        padding: '14px', borderRadius: 14,
                                        fontSize: 14, fontWeight: 800, cursor: 'pointer'
                                    }, children: "Tizimga kirish" })] })] }) })) : (_jsxs(_Fragment, { children: [_jsx("div", { style: { padding: '0 20px' }, children: _jsxs("div", { className: "card", style: { display: 'flex', alignItems: 'center', gap: 14 }, children: [_jsx("div", { style: {
                                ...
                                opacity: (!isInstalled && !canInstall) ? 0.6 : 1,
                                                ...
                                                : 'Telefonga yuklab oling — tezroq ishlaydi' })] }), !isInstalled && canInstall && _jsx("div", { style: { color: 'var(--g)', fontSize: 18, fontWeight: 800 }, children: "\u2193" })] }) }), pendingOrders.length > 0 && (_jsx("div", { style: { padding: '12px 20px 0' }, children: pendingOrders.map(o => (_jsxs("div", { style: {
                                background: 'rgba(255,204,68,0.1)',
                                border: '1px solid rgba(255,204,68,0.3)',
                                borderRadius: 14, padding: 14,
                                marginBottom: 8,
                                display: 'flex', alignItems: 'flex-start', gap: 12
                            }, children: [_jsx("div", { style: { fontSize: 24 }, children: "\u23F3" }), _jsxs("div", { style: { flex: 1 }, children: [_jsx("div", { style: { fontWeight: 800, fontSize: 13, color: 'var(--y)' }, children: "Tasdiq kutilmoqda" }), _jsxs("div", { style: { fontSize: 11, color: 'var(--txt-2)', marginTop: 4, lineHeight: 1.4 }, children: [_jsx("b", { children: o.planName }), " tarifi uchun so'rov adminga yuborilgan.", _jsx("br", {}), "Buyurtma ID: ", _jsx("code", { style: { color: 'var(--g)' }, children: o.orderId })] })] })] }, o.orderId))) })), level && (_jsxs(_Fragment, { children: [_jsx("div", { className: "section-title", children: "\uD83D\uDCCA Daraja statistikasi" }), _jsx("div", { style: { padding: '0 20px' }, children: _jsxs("div", { style: {
                                        ...
                                        padding: 16,
                                                ...
                                                color: 'var(--txt-3)',
                                                lineHeight: 1.5,
                                            }, children: ["\uD83D\uDCA1 Daraja har oy boshida nolga tushadi. Joriy oy: ", level.currentMonth] })] }) })] })), _jsx("div", { className: "section-title", children: "Testlar tarixi" }), _jsx("div", { style: { padding: '0 20px 12px' }, children: _jsxs("button", { onClick: () => navigate('/tarix'), style: {
                                width: '100%',
                                background: 'var(--s1)',
