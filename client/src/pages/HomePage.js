...
export default function HomePage() {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "header", children: [_jsxs("div", { className: "header-logo", children: ["FIKRA", _jsx("span", { children: "." })] }), _jsx("button", { className: "plan-pill", onClick: () => setSubOpen(true), children: isSub
                        ...
                        borderRadius: 14,
                        padding: 14,
                    }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }, children: [_jsx("span", { style: { fontSize: 20 }, children: "\uD83C\uDF89" }), _jsxs("div", { style: { fontWeight: 800, fontSize: 14, color: 'var(--acc-l)' }, children: ["Xush kelibsiz, ", user.displayName || user.firstName || 'abituriyent', "!"] })] }), _jsxs("div", { style: { fontSize: 12, color: 'var(--txt-2)', lineHeight: 1.55 }, children: ["1\uFE0F\u20E3 ", _jsx("strong", { children: "Ombor" }), "ga material yuklab boshlang", _jsx("br", {}), "2\uFE0F\u20E3 AI sizning materialingizdan ", _jsx("strong", { children: "sifatli test" }), " yaratadi", _jsx("br", {}), "3\uFE0F\u20E3 Test ishlab, ", _jsx("strong", { children: "xatolaringizni o'rganib" }), " rivojlaning"] })] }) })), _jsx("div", { className: "section-title", children: "Asosiy bo'limlar" }), _jsxs("div", { style: { padding: '0 20px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }, children: [_jsx(MenuCard, { icon: "\uD83C\uDFDB", title: "Ombor", subtitle: "Materiallar", color: "rgba(167,139,250,0.15)", onClick: () => navigate('/ombor') }), _jsx(MenuCard, { icon: "\uD83D\uDCDD", title: "Testlar", subtitle: "DTM va AI", color: "rgba(0,212,170,0.15)", onClick: () => navigate('/testlar') }), _jsx(MenuCard, { icon: "\uD83D\uDCDA", title: "Tarix", subtitle: "Ishlagan testlar", color: "rgba(59,130,246,0.15)", onClick: () => navigate('/tarix') }), _jsx(MenuCard, { icon: "\uD83E\uDD16", title: "AI", subtitle: "Chat \u00B7 Hujjat \u00B7 Rasm", color: "rgba(251,191,36,0.15)", onClick: () => navigate('/ai') })] }), !isInstalled && canInstall && (_jsx("div", { style: { padding: '16px 20px 0' }, children: _jsxs("button", { onClick: installPwa, style: {
                        width: '100%',
