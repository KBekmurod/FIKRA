...
export default function HomePage() {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "header", children: [_jsxs("div", { className: "header-logo", children: ["FIKRA", _jsx("span", { children: "." })] }), _jsx("button", { className: "plan-pill", onClick: () => setSubOpen(true), children: isSub
                        ...
                        gap: 14,
                    }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 14 }, children: [_jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsxs("div", { style: { fontWeight: 800, fontSize: 16 }, children: ["\uD83D\uDC4B Salom, ", user.firstName || 'Abituriyent', "!"] }), _jsx("div", { style: { fontSize: 12, color: 'var(--txt-2)', marginTop: 4 }, children: "Joriy darajangiz" }), _jsx("div", { style: {
                                                marginTop: 6,
                                                display: 'inline-block',
                                                fontSize: 13,
                                                fontWeight: 800,
                                                ...
                                                letterSpacing: 0.3,
                                            }, children: _jsxs(_Fragment, { children: [gradeMeta.icon, " ", gradeMeta.name, " ", versionInGr] }) })] }), _jsx(LevelCrystal, { level: level ? level.currentVersion : 1, streak: level ? level.streak : 0 })] }), _jsxs("div", { style: {
...
function MenuCard({ icon, title, subtitle, color, onClick, className, onMouseEnter, style }) {
    ...
    return (_jsxs(motion.button, { onClick: onClick, onMouseEnter: onMouseEnter, onMouseMove: handleMouse, onMouseLeave: handleMouseLeave, className: className, style: {
            background: color,
            border: '1px solid var(--f)',
            borderRadius: 14,
            padding: 16,
            ...
            ...style
        }, whileHover: { scale: 1.05, zIndex: 10 }, whileTap: { scale: 0.95 }, children: [_jsx(motion.div, { style: {
                    position: 'absolute',
                    ...
                    pointerEvents: 'none',
                    borderRadius: 14
                } }), _jsx(motion.div, { style: { fontSize: 26, lineHeight: 1, translateZ: 40 }, children: icon }), _jsx(motion.div, { style: { fontWeight: 800, fontSize: 14, translateZ: 20 }, children: title }), _jsx(motion.div, { style: { fontSize: 10, color: 'var(--txt-2)', translateZ: 10 }, children: subtitle })] }));
}
