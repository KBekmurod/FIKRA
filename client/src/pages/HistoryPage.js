...
export default function HistoryPage() {
    ...
    return (<>
      ...
      {!user ? (<div style={{ padding: '40px 20px', textAlign: 'center' }}>
        ...
        {loading ? (<div className="skel-card"/>) : topTab === 'fikra' ? (<FikraHistoryList items={fikraByMode} onClick={function (s) { return navigate("/test-result/" + s._id); }}/>) : (<AiHistoryList primaryItems={primaryAi} miniItems={miniAi} allTests={ai} onClick={function (t) { return navigate("/personal-tests/" + t._id + "/result"); }}/>)}
