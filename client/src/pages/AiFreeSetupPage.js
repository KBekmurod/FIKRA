...
export default function AiFreeSetupPage() {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "header", children: [_jsx("button", { onClick: goBack, style: {
                        ...
                        }) }), _jsx("button", { onClick: startTest, disabled: !isReady, style: {
                            width: '100%',
                        ...
                        }, children: isReady ? `🚀 ${totalQuestions} ta savolli testni boshlash` : 'Kamida 2 ta fan tanlang' }), _jsx("div", { style: { height: 30 } })] })] }));
}
