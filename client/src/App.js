...
export default function App() {
    ...
    return (_jsxs("div", { className: "app", children: [_jsx(AuthModal, {}), !isInstalled && canInstall && !isAuthRoute && (_jsxs("div", { style: {
