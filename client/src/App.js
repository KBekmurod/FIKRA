...
export default function App() {
    ...
    return (_jsxs("div", { className: "app", children: [!isInstalled && canInstall && !isAuthRoute && (_jsxs("div", { style: {
