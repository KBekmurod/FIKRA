...
export var COMPULSORY_IDS = ['majburiy_onatili', 'majburiy_math', 'majburiy_tarix'];
export var SPEC_IDS = [
...
export var DUAL_CONTEXT_SUBJECTS = new Set();
export var ONLY_COMPULSORY_SUBJECTS = new Set(COMPULSORY_IDS);
export var ONLY_SPECIALTY_SUBJECTS = new Set(SPEC_IDS);
