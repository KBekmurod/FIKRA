...
export var useAppStore = create(function (set, get) { return ({
    ...
    login: function (identifier, password) { return __awaiter(_this, void 0, void 0, function () {
        var data, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, authApi.login(identifier, password)];
                case 2:
                    data = (_a.sent()).data;
    ...
    register: function (identifier, password, name) { return __awaiter(_this, void 0, void 0, function () {
        var data, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, authApi.register(identifier, password, name)];
                case 2:
                    data = (_a.sent()).data;
                    setAuth(data.accessToken, data.refreshToken);
                    set({ user: data.user, loading: false, initialized: true });
