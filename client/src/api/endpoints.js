...
export var authApi = {
    ...
    register: function (identifier, password, name) {
        return api.post('/api/auth/register', { identifier: identifier, password: password, name: name });
    },
    ...
    changePassword: function (oldPassword, newPassword) {
        return api.post('/api/auth/change-password', { oldPassword: oldPassword, newPassword: newPassword });
    },
    // Mavjud akkountga email yoki telefon qo'shish
    addIdentifier: function (data) {
        return api.post('/api/auth/add-identifier', data);
    },
    // Joriy user
...
// ─── Streaming chat ────────────────────────────────────────────────────────
export function streamChat(message, sessionId, onChunk, onSessionId, onDone, onError) {
...
export function streamJsonFetch(url, body) {
    return __awaiter(this, void 0, Promise, function () {
        var auth, API_BASE, res, err, reader, decoder, buffer;
